...
var StackController = /** @class */ (function () {
    ...
    StackController.prototype.createView = function (enteringRef, activatedRoute) {
    ...
    StackController.prototype.setActive = function (enteringView) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, direction, animated, leavingView;
    ...
    StackController.prototype.startBackTransition = function (stackId) {
        if (stackId === void 0) { stackId = this.getActiveStackId(); }
        var views = this.getStack(stackId);
        this.transition(views[views.length - 2], // entering view
